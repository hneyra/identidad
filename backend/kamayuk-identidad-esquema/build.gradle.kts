// kamayuk-identidad-esquema no es un contexto acotado: contiene las migraciones Flyway, el
...
// reutiliza kamayuk-identidad-plataforma para su prueba con el pool real. Un segundo arranque
...
application {
    mainClass.set("kamayuk.identidad.esquema.Migrador")
