package kamayuk.identidad.plataforma.identidad;
...
import kamayuk.identidad.plataforma.ConfiguracionDeTenant;
import kamayuk.identidad.plataforma.SeguridadWeb;
...
// kamayuk-identidad-aplicacion (application.yaml), no el comportamiento por omision del starter.
...
class CadenaDeIdentidadTest {
    ...
    class Accesos {
        ...
        void conElClaimDeAseVenLosDeA() throws Exception {
            ...
            assertThat(respuesta.body()).contains("Identidad A");
        ...
        void unaMunicipalidadNoVeLaOtra() throws Exception {
            ...
            assertThat(deA).contains("Identidad A").doesNotContain("Identidad B");
            assertThat(deB).contains("Identidad B").doesNotContain("Identidad A");
        }
        ...
        void elEncabezadoHostilNoGana() throws Exception {
            ...
            assertThat(respuesta.body())
                    ...
                    .contains("Identidad A")
                    .doesNotContain("Identidad B");
        }
    }
    ...
    static class ControladorDePrueba {
        ...
        static final String RUTA = "/identidad/api/v1/prueba/conjuntos";
