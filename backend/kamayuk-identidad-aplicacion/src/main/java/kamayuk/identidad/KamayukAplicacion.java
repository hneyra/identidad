...
/**
 * Artefacto unico de {@code identidad}, desplegado en los perfiles {@code web} y {@code batch}
 * (ADR-0003). Mismo codigo y misma imagen; lo que cambia es la configuracion.
 *
