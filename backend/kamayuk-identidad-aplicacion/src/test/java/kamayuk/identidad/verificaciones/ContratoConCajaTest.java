 ...
 * caja/docs/50-api/contratos-que-consume/identidad.json}. El rojo tiene que llegar <b>aqui</b> y no
 * alli: quien retira un campo de la respuesta es este repositorio, y con la prueba del lado del
 ...
 * {@code caja} y ese ingestor es de la etapa 4 — y no se podia dejar activa esperando: {@code
