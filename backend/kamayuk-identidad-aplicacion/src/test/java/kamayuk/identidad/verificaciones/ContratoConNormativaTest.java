 ...
 * lee y aceptando el cuerpo que manda, tal como ese ingestor lo declara en {@code
 * normativa/docs/50-api/contratos-que-consume/identidad.json}. El rojo tiene que llegar <b>aqui</b>
 * y no alli: quien retira un campo de la respuesta es este repositorio, y con la prueba del lado
 * del consumidor el aviso le llegaria a quien no rompio nada.
 *
 ...
 * {@code normativa} y ese ingestor es de la etapa 4 — y no se podia dejar activa esperando: {@code
