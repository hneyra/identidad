...
import kamayuk.identidad.seguridad.infraestructura.RegistroDeMunicipalidadesJdbc;
 ...
 * es la plantilla de quien administra <b>el acceso de los usuarios</b>, y en la etapa 1 esas
 * pantallas siguen viviendo en {@code rentas} (ADR-0030 §3): crear aqui un grupo que no puede
 * administrar nada seria decir que existe una delegacion que no existe. En la etapa 2, cuando las
 * once escrituras lleguen, ese segundo grupo tiene que venir con ellas.
 *
...
public class ImplantarMunicipalidad implements ApplicationRunner {
    ...
    public void run(ApplicationArguments argumentos) {
        ...
        try {
            ...
            log.info(
                    "Municipalidad {} lista en identidad ({}): id {}, {} accesos nuevos,"
                            + " administrador '{}'",
                    datos.ubigeo(),
