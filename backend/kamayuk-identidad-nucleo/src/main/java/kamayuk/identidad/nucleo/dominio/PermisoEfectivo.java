 ...
 * </ol>
 *
 * @param sistema de que catalogo es la opcion. Va con el codigo y no aparte: aqui el codigo solo no
 *     identifica nada, porque esta base guarda los catalogos de los cinco (ver {@link Acceso})
...
public record PermisoEfectivo(
    ...
    public PermisoEfectivo {
        Objects.requireNonNull(sistema, "Un permiso efectivo dice de que sistema es su opcion");
