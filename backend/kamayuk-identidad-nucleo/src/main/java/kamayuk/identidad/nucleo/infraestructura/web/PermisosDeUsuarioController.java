...
public class PermisosDeUsuarioController {
    ...
    public List<PermisosController.PermisoResource> fijar(
        ...
        for (PermisosController.NivelDeAcceso nivel :
            ...
            String sistema = PermisosController.sistemaDe(nivel);
            ...
            Permiso permiso =
                    administrar.fijarParaUsuario(
                            ...
                            sistema,
                            acceso,
                            PermisosController.privilegios(nivel),
                            observacion);
            resultado.add(PermisosController.PermisoResource.de(permiso, sistema, acceso));
        }
        return resultado;
    }
}
