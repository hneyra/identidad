...
import kamayuk.identidad.nucleo.aplicacion.AdministrarPermisos.PermisosConfigurados;
...
public final class Recursos {
    ...
    /**
     * Un modulo del menu, y <b>de que sistema es</b>.
     *
     * <p>El campo no es informativo: esta base guarda los catalogos de los cinco (ADR-0039) y tres
     * de ellos tienen un modulo {@code SEGURIDAD}. Sin el, quien dibuja el arbol de una
     * municipalidad recibe tres filas con el mismo codigo y ninguna forma de separarlas.
     */
    public record ModuloResource(
    ...
    /**
     * Una opcion, y <b>de que catalogo</b>. Mismo motivo que en {@link ModuloResource}: aqui el
     * codigo solo no identifica ninguna opcion —{@code permisos} es una de {@code identidad} y otra
     * de {@code rentas}— y quien fije un permiso tiene que mandar el par.
     */
