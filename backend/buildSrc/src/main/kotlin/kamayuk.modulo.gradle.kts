...
// plugin de Spring Boot: solo kamayuk-identidad-aplicacion produce un artefacto ejecutable.
...
dependencies {
    ...
    // SET LOCAL). Vive en kamayuk-identidad-plataforma, que declara `api` sobre
