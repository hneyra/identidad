// Raiz del build de `identidad`. No produce artefactos: solo agrupa y declara las dos tareas
...
tasks.register("verificarAislamiento") {
    ...
    dependsOn(":kamayuk-identidad-esquema:test", ":kamayuk-identidad-plataforma:test")
}
...
tasks.register("verificarArquitectura") {
    ...
    dependsOn(":kamayuk-identidad-aplicacion:test")
}
...
tasks.register("verificarArranque") {
    ...
    dependsOn(":kamayuk-identidad-aplicacion:pruebaDeArranque")
}
